...
$result = mysql_query("INSERT INTO blog (id, title, content, date) VALUES ('$id','$title','$content','$date')") or die(mysql_error());
...
<h2 style = "margin-left: 15px;">Add Blog</h2>
 ...
 <form method = "post" action = "edit.php?id=<?php echo $id;?>">
                  ...
                  <p style = "margin-left: 80px;"> <?php echo $report; ?><br /><br /> </p>
                    <table>
                    <tr><td><label>Title:</label></td><td><input type="text" name="title" class="contact_inputa" value = "Enter Blog Title"/></td></tr>
                                        
                    
                     
                    <tr><td><label>Content:</label></td><td><textarea rows=10 cols = 40 name="content" class="contact_textareaa" >Enter Blog Content Here</textarea></td></tr>
