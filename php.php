	...
	<div class="content">
		...
		<div id="main">
			...
			<div class="left_side">
				...
				<textarea id="code" class="codepress php linenumbers-on" style="width:450px;height:300px;" name = "code">
   <?php 
...
<input type = "submit" value = "Save" name = "save_h" id = "save_h"/>&nbsp;<input type = "button" value = "Run" name = "run_h" id = "run_h" onClick="reload();"/>
</form>
			</p><br />
			
			Terminal Output:
			
<iframe src='<?php echo "./files/".$_COOKIE['usern']."/".$_GET['file']."";?>' frameborder = 0 seamless width="700px" height= "300px" name = "op" id="op"></iframe> 
			</div>
		</div>
