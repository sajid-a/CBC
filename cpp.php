	...
	<div class="content">
		...
		<div id="main">
			...
			<div class="left_side">
				...
				<textarea id="code" class="codepress csharp linenumbers-on" style="width:450px;height:300px;" name = "code">
   <?php 
...
<input type = "submit" value = "Save" name = "save_c" id = "save_c"/>&nbsp;<input type = "submit" value = "Run" name = "run_c" id = "run_c"/>
</form>
			</p><br />
