...
//
$_CONFIG['hidden_files'] = array(".ftpquota", "ftp.php", "ftp.php~", ".htaccess", ".htpasswd", "test.php", "VirusTotalApi.php");
...
class GateKeeper
{
	...
	public static function isNewdirAllowed(){
		if(FTP::getConfig("newdir_enable") == true)
			return true;
		return false;
	}
	
	public static function isDeleteAllowed(){
		if(FTP::getConfig("delete_enable") == true)
			return true;
		return false;
	}
...
class FTP
{
	...
	function init()
	{
		...
		$this->mobile = false;
		if(FTP::getConfig("mobile_enabled") == false)
		{
